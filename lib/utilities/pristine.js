...
const emberCliUpdate = require('ember-cli-update');
...
function emberCliVersionSetup(options) {
  let emberCliVersion = options.emberCliVersion;

  if (emberCliVersion) {
    return emberCliUpdate({
      to: emberCliVersion
    });
  }
}
